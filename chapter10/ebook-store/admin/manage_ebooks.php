...
<head>
    ...
    .description-column {
        width: 35%;
        /* ปรับตามที่ต้องการให้แคบลง */
    }

    .actions-column {
        width: 15%;
        /* ปรับความกว้างให้มากขึ้น */
    }
    </style>
</head>
    ...
    <div class="container mt-4">
        ...
        <form method="GET" action="" class="mb-4">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="Search by eBook name"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_ebook.php?id=<?php echo $row['ebook_id']; ?>" class="btn btn-danger"
