...
if (isset($_GET['search'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM ebooks WHERE name LIKE :searchQuery");
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100">
                    <!-- เพิ่ม class h-100 เพื่อให้ Card สูงเท่ากัน -->
                    <img src="images/<?= htmlspecialchars($ebook['image']) ?>" class="card-img-top custom-image"
                        alt="<?= htmlspecialchars($ebook['name']) ?>">
                    <div class="card-body d-flex flex-column">
                        <!-- เพิ่ม d-flex และ flex-column เพื่อจัดเนื้อหาภายในให้ยืดหยุ่น -->
                        ...
                        <!-- ใช้ฟังก์ชัน limitCharacters -->
                        <p class="card-text mt-auto">ราคา: <?= htmlspecialchars($ebook['price']) ?> บาท</p>
                        <!-- ใส่ mt-auto เพื่อให้ข้อความราคาติดอยู่ด้านล่าง -->
